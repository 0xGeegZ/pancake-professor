...
const ElectricalServicesTwoToneIconWrapper = styled(ElectricalServicesTwoToneIcon)(
  ({ theme }) => `
...
function PowerConsumption() {
  ...
  const power = {
    day:
      [344, 512, 829, 696, 847, 437, 935, 433]
    ,
    week:
      [2662, 2583, 2746, 4756, 4201, 1869, 5694]
    ,
    month: [
      34471,
      37403,
  ...
  return (
    <>
      ...
      <Card sx={{ pb: 3 }}>
        ...
        {location === 'Daily' && (
          <Box height={250}>
            <PowerConsumptionChartWrapper data={power.day} labels={generic.day} />
          </Box>
        )}
        {location === 'Weekly' && (
          <Box height={250}>
            <PowerConsumptionChartWrapper data={power.week} labels={generic.week} />
          </Box>
        )}
        {location === 'Monthly' && (
          <Box height={250}>
            <PowerConsumptionChartWrapper
              data={power.month}
