...
const IconWrapper = styled(IconButton)(
  ({ theme }) => `
      ...
      border-radius: 50px;
      box-shadow: 0px 1px 4px ${theme.colors.alpha.black[30]}, 0px 3px 12px 2px ${theme.colors.alpha.black[10]};
      display: flex;
      align-items: center;
      ...
      <Card sx={{ p: 2 }}>
        <Stack spacing={3} direction="row" justifyContent="space-evenly">
          <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center">
            ...
            <Typography variant="h5" textAlign="center" lineHeight="1.3" color="text.secondary">
              {t('Start music')}
            </Typography>
          </Box>
          <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center">
