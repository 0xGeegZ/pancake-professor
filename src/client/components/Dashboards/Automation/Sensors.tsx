          ...
          <WallPaper>
            <Widget>
              ...
              <Box
                ...
                <IconButton sx={{ borderRadius: '50px' }} aria-label="next song">
          ...
          <CardWrapper sx={{ pb: 3 }}>
            <Box display="flex" justifyContent="space-between" p={3} alignItems="center">
              <Box display="flex" alignItems="center">
                ...
                <Typography sx={{ pl: 1 }} variant="h4" color="text.secondary" noWrap fontWeight="bold">
                  {t('Master bedroom')}
                </Typography>
              </Box>
            ...
            <Box px={3} display="flex" alignItems="center" justifyContent="space-between">
              <Typography align="center" variant="h1" sx={{ mt: '-4px' }}>
                <Text color="success">
                  25.4<sup>°</sup>
                </Text>
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={12}>
          <CardWrapper sx={{ pb: 3 }}>
            <Box display="flex" justifyContent="space-between" p={3} alignItems="center">
              <Box display="flex" alignItems="center">
                <OpacityTwoToneIcon />
                <Typography sx={{ pl: 1 }} variant="h4" noWrap color="text.secondary" fontWeight="bold">
                  {t('Humidity')}
                </Typography>
              </Box>
