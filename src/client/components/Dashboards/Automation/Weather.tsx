...
function Weather() {
  ...
  return (
    <WeatherBox>
      <TopBarImage sx={{ backgroundImage: 'url("/static/images/placeholders/covers/automation-bg.jpg")' }} />
      <WeatherBoxContent>
        <Grid container spacing={4}>
          <Grid item xs={12} sm={12} md={6} lg={7}>
            <Typography variant="h2" sx={{ my: 2 }} gutterBottom>
              {t('Hello')}, Margaret Gale!
            </Typography>
            <Typography sx={{ lineHeight: 1.5, fontWeight: 'normal', mb: 4 }} variant="h4">
              {t('Partly cloudy conditions from 3PM to 6PM, with mostly cloudy conditions expected at 6PM')}.
            </Typography>
            <Grid container spacing={3}>
              ...
              <Grid item md={6}>
                <BoxWeatherSmall>
                  ...
                  <Box display="flex" justifyContent="center" flexDirection="column" sx={{ pt: 4, height: 138 }}>
                    <Gauge
                      circleRatio={0.65}
          ...
          <Grid item xs={12} sm={12} md={6} lg={5} display="flex" justifyContent="center">
            <BoxWeather>
              ...
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                ...
                <Box>
                  <Typography sx={{ color: `${theme.colors.alpha.trueWhite[50]}` }} variant="h5">
                    10<sup>°</sup>
                  </Typography>
                </Box>
                <Box mx={1} sx={{ width: '35%' }}>
                  <LinearHighLow />
                </Box>
                <Box>
