  ...
  return (
    <Card sx={{ py: 2, display: 'flex', alignItems: 'center', height: '100%' }}>
      <Box sx={{ width: '100%' }}>
        ...
        <Typography align="center" variant="h3" fontWeight="normal" color="text.secondary" gutterBottom>
          {t('Today')}
        </Typography>
        <GaugeChart
        ...
        <GaugeChart
          ...
          nrOfLevels={16}
          hideText
          colors={[theme.colors.primary.main, theme.colors.primary.light, theme.colors.primary.lighter]}
          needleColor={theme.colors.alpha.black[100]}
          needleBaseColor={theme.colors.alpha.black[100]}
          arcWidth={0.2}
          arcPadding={0.02}
