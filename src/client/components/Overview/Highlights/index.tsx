    ...
    <BoxHighlights>
        ...
        <BoxLayoutsContent maxWidth="lg">
          <Grid justifyContent="center" alignItems="center" spacing={6} container>
            <Grid item xs={12} md={6}>
              ...
              <TypographySubHeading className="typo-subheading"
                sx={{ lineHeight: 1.5 }}
                variant="h4"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 10 } }}>
        <Grid spacing={0} direction={{ xs: 'column-reverse', md: 'row' }} justifyContent="center" container>
          <Grid item xs={12} md={6}>
            <Box sx={{ top: { xs: -50, md: 0 }, left: { xs: -150, md: -45 }, minHeight: { xs: '530px', md: '1000px' }, transform: { xs: 'scale(.5)', md: 'none' }, position: 'relative' }}>
              <Button size="large" component={Link} href="/dashboards/banking" variant="contained" sx={{ position: 'absolute', display: { xs: 'none', lg: 'block' }, right: { xs: 0, md: -80, lg: 50 }, bottom: 150 }}>
                View more components
              </Button>
              <Box sx={{
                position: 'absolute', width: 500, top: -50, left: -30,
              ...
              <Box sx={{
                position: 'absolute', width: 300, top: -180, left: 210,
                transform: 'translate(0px, 120px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 330, top: 635, left: 970,
              ...
              <Box sx={{
                position: 'absolute', width: 280, top: 320, left: -42,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 330, top: 365, left: 250,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 500, top: 240, left: 910,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 400, top: 480, left: 700,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
                <Box sx={{ animation: '2.5s 3s infinite alternate ease-in-out float' }}>
              ...
              <Box sx={{
                position: 'absolute', width: 400, top: 545, left: 515,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 330, top: 213, left: 477,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
              ...
              <Box sx={{
                position: 'absolute', width: 330, top: 535, left: 10,
                transform: 'translate(0px, 20px) perspective(5200px) rotate(90deg) rotateY(-45deg) rotateZ(-45deg)',
                transformStyle: 'preserve-3d'
              }}>
                <Box sx={{ animation: '2s 2s infinite alternate ease-in-out float' }}>
            ...
            <Box>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/automation" variant="outlined">
                    {t('Automation')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/analytics" variant="outlined">
                    {t('Analytics')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/banking" variant="outlined">
                    {t('Banking')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/commerce" variant="outlined">
                    {t('Commerce')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/crypto" variant="outlined">
                    {t('Crypto')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/finance" variant="outlined">
                    {t('Finance')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/fitness" variant="outlined">
                    {t('Fitness')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/healthcare/doctor" variant="outlined">
                    {t('Doctor')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/healthcare/hospital" variant="outlined">
                    {t('Hospital')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/helpdesk" variant="outlined">
                    {t('Helpdesk')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/learning" variant="outlined">
                    {t('Learning')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/monitoring" variant="outlined">
                    {t('Monitoring')}
                  </Button>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/dashboards/tasks" variant="outlined">
                    {t('Tasks')}
                  </Button>
                </Grid>
              </Grid>
          ...
          <Grid item md={8}>
            <Box sx={{ position: 'relative' }}>
              ...
              <Typography variant="subtitle1" sx={{ py: 2 }} component="p">
                <Text color="warning"><b>{t('Includes redux state management, working forms with validation, working filtering and more')}</b></Text>
              </Typography>
              <Grid container spacing={3}>
                  ...
                  <Card sx={{ mt: 2 }}>
                    <List disablePadding>
                      <ListItem sx={{ py: 2 }}>
                        ...
                        />
                        <Button size="small" target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/applications/jobs-platform">
                          {t('View')}
                        </Button>
                      </ListItem>
                    </List>
                    ...
                    <List disablePadding>
                      <ListItem sx={{ py: 2 }}>
                        ...
                        <ListItemText
                          ...
                          secondaryTypographyProps={{ variant: 'subtitle2', noWrap: true }}
                        />
                        <Button size="small" target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/applications/projects-board">
                          {t('View')}
                        </Button>
                      </ListItem>
                    </List>
                    ...
                    <List disablePadding>
                      <ListItem sx={{ py: 2 }}>
                        ...
                        <ListItemText
                          ...
                          secondaryTypographyProps={{ variant: 'subtitle2', noWrap: true }}
                        />
                        <Button size="small" target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/applications/messenger">
                          {t('View')}
                        </Button>
                      </ListItem>
                    </List>
                    ...
                    <List disablePadding>
                      <ListItem sx={{ py: 2 }}>
                        ...
                        <ListItemText
                          ...
                          secondaryTypographyProps={{ variant: 'subtitle2', noWrap: true }}
                        />
                        <Button size="small" target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/applications/file-manager">
                          {t('View')}
                        </Button>
                      </ListItem>
                    </List>
        ...
        <Grid container direction={{ xs: 'column-reverse', md: 'row' }} sx={{ mt: 12, mb: 12 }} spacing={3}>
          <Grid item md={6} lg={7}>
            <Box sx={{ transform: { xs: 'scale(.9)', md: 'scale(.85)', lg: 'none' }, left: { xs: '50px', md: '-180px', lg: '-45px' }, minHeight: 600, position: 'relative' }}>
              <Box sx={{
          ...
          <Grid item md={6} lg={5}>
            ...
            <TypographyHeading sx={{ mb: 1 }} variant="h3">
              Pre-Built <br />Management Sections
            </TypographyHeading>
            <TypographySubHeading
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/users" variant="outlined">
                  {t('Users')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/users/2" variant="outlined">
                  {t('Profile')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/projects" variant="outlined">
                  {t('Projects')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/commerce/products/2" variant="outlined">
                  {t('View Product')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/commerce/products/create" variant="outlined">
                  {t('Create Product')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/commerce/shop" variant="outlined">
                  {t('Shop')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/invoices" variant="outlined">
                  {t('Invoices')}
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Button fullWidth target="_blank" rel="noopener" startIcon={<LaunchTwoToneIcon />} component={Link} href="/management/invoices/7" variant="outlined">
                  {t('Single Invoice')}
                </Button>
              </Grid>
            </Grid>
        ...
        {currentTab === 'extra_pages' && (
          <>
            ...
            <Container sx={{ position: 'relative', pb: 4 }} maxWidth="sm">
              ...
              >
                {t(
                  'Either use next-auth or build a custom auth solution using these ready-made pages'
                )}
                .
              </TypographyH2>
            </Container>
            ...
            <Grid container sx={{ textAlign: 'center' }} spacing={3}>
              <Grid item xs={12} md={4}>
                ...
                <Typography variant="subtitle2">
                  {t(
                    'Choose the page style that best suits your app'
                  )}
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
