...
function Introduction() {
  return (
    <>
      <Head>
        <title>Introduction - Tokyo NextJS Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            ...
            <Typography paragraph>
              Tokyo NextJS Admin Dashboard includes multiple pages that can be
            ...
            <Typography paragraph>
              We designed 7 different color schemes that can be switched from
              the Settings dropdown in the live preview header section. There
              are 4 light color schemes and 3 dark ones.
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              Tokyo NextJS Admin Dashboard is built {' '} for
              <code>NextJS</code> from Vercel. Next.js gives you the best developer experience with all the features you need for production: hybrid static & server rendering, TypeScript support, smart bundling, route pre-fetching, and more. No config needed.
