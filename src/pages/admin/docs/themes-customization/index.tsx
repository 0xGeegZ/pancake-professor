...
function ThemesCustomization() {
  ...
  return (
    <>
      <Head>
        <title>Themes Customization - Tokyo NextJS Admin Dashboard</title>
      </Head>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo NextJS Admin Dashboard come with 7 predefined color schemes.
            </Typography>
            <Typography paragraph>
              Four of them are 'light' color schemes: <code>Pure Light</code>,{' '}
              <code>Light Bloom</code>, <code>Purple Flow</code> and <code>Grey Goose</code>. The other
              three are 'dark' color schemes: <code>Nebula Fighter</code>, <code>Green Fields</code> and{' '}
              <code>Dark Spaces</code>.
            </Typography>
            <Typography paragraph>
              If you're looking to use only a single color scheme, then you'll need to remove the files and references for the color schemes that you're not going to use from <code>/src/client/theme/schemes</code>, <code>/src/client/theme/base.ts</code> and <code>/src/client/theme/ThemeProvider.tsx</code>.
            </Typography>
            <br />
            <Typography paragraph>
              You can find all the theme logic inside the{' '}
              <code>/src/client/theme/</code> folder. Switch between themes using the
              top right 'cog' menu.
            </Typography>
            <Prism
              showLineNumbers
